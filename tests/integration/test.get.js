...
adapters.forEach(function (adapter) {
  describe('test.get.js-' + adapter, function () {
    ...
    it.only('5857 - open_revs with latest=true', function () {
      var db = new PouchDB(dbs.name);
      var first = null;
    ...
    it.only('5857 - multiple open_revs for the same branch with latest=true returns one result', function () {
      var db = new PouchDB(dbs.name);
      var first = null;
      return db.post({ version: 'first' })
        .then(function (info) {
    ...
    it.only('5857 - GET losing, old revision with latest=true', function () {
      var db = new PouchDB(dbs.name);
      var doctree = [
        {
          _id: 'mydoc',
    ...
    it.only('5857 - GET open_revs losing, old revision with latest=true', function () {
      var db = new PouchDB(dbs.name);
      var doctree = [
        {
          _id: 'mydoc',
    ...
    it.only('5857 - GET latest=true with conflicting parent revs', function () {
      var db = new PouchDB(dbs.name);
      var doctree = [
        {
          _id: 'mydoc',
    ...
    it.only('5857 - GET latest=true with deleted conflict parent revs', function () {
      var db = new PouchDB(dbs.name);
      var doctree = [
        {
          _id: 'mydoc',
